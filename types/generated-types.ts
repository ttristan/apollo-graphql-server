...
export type Mutation = {
  __typename?: 'Mutation';
  exampleChange?: Maybe<Example>;
};


export type MutationExampleChangeArgs = {
  id: Scalars['Int'];
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  hello?: Resolver<Maybe<ResolversTypes['Example']>, ParentType, ContextType>;
};

export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  exampleChange?: Resolver<Maybe<ResolversTypes['Example']>, ParentType, ContextType, RequireFields<MutationExampleChangeArgs, 'id'>>;
};
